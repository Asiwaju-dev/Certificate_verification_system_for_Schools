	...
	<div class="w3ls-pos">
		...
		<div class="w3ls-login box">
			...
			<form class="form loginform" method="POST" action="authenticate.php">
				...
				<a style="color: black;" href="/Online-Certificate-Verification/"><button type="button" class="btn btn-outline-danger btn-lg" style="background-color: #F9A826;">Main Site</button></a>
				</div>
			</form>
		</div>
