<fieldset>
    ...
    <div class="form-group">
        <label for="certificate_number">Certificate Verification Code (CVC). *</label>
    ...
    <div class="form-group">
        <label for="training_name">Degree Name *</label>
        <input type="text" name="training_name" value="<?php echo htmlspecialchars($edit ? $customer['training_name'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="Degree Name" class="form-control" required="required" id="training_name">
    </div>
    <div class="form-group">
        <label for="college_name">University Name *</label>
        <input type="text" name="college_name" value="<?php echo htmlspecialchars($edit ? $customer['college_name'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="University Name" class="form-control" required="required" id="college_name">
    </div>
    <div class="form-group">
        <label for="college_name">Grade *</label>
    ...
    <div class="form-group">
        <label>State</label>
        <?php $opt_arr = array("Abuja", "Abia", "Adamawa", "Akwa Ibom", "Anambra", "Bauchi", "Bayelsa", "Benue", "Borno", "Cross River", "Delta", "Ebonyi", "Edo", "Ekiti", "Enugu", "Gombe", "Imo", "Jigawa", "Kaduna", "Kano", "Katsina", "Kebbi", "Kogi", "Kwara", "Lagos", "Nassarawa", "Niger", "Ogun", "Ondo", "Osun", "Oyo", "Plateau", "Rivers", "Sokoto", "Taraba", "Yobe", "Zamfara"); ?>
