                    ...
                    <div class="col-xs-12">
                      <div class="row">
                        ...
                        <div class="pm-earned col-xs-8 text-center">
                          ...
                          <span class="pm-credits-text block bold sans">'.$result['marks'].' having completed the approved course of study and fulfilled all the prescribed conditions in the degree program.</span>
                        </div>
                        <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
                    ...
                    <div class="col-xs-12">
                      <div class="row">
                        ...
                        <div class="pm-course-title col-xs-8 text-center">
                          <span class="pm-earned-text block cursive">This student is hereby awarded the following degree</span>
                        </div>
                        <div class="col-xs-2"><!-- LEAVE EMPTY --></div>
                      </div>
                    </div>
